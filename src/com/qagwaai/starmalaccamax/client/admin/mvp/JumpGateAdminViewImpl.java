 ...
 * 
 */
public class JumpGateAdminViewImpl extends AbstractView<JumpGateAdminPresenter> implements AdminFileUpload,
    JumpGateAdminView {
     ...
     */
    public JumpGateAdminViewImpl(final String location) {
        this();
    ...
    public final void layout() {
        ...
        String title = Canvas.imgHTML("silk/world.png") + " " + constants.jumpGateAdminView_jumpGateSectionTitle();
        ...
        listGrid.setDataPageSize(DATA_PAGE_SIZE);
