 ...
 * 
 */
public class ShipTypeAdminViewImpl extends AbstractView<ShipTypeAdminPresenter> implements AdminFileUpload,
    ShipTypeAdminView {
     ...
     */
    public ShipTypeAdminViewImpl(final String location) {
        this();
    ...
    public final void layout() {
        ...
        String title = Canvas.imgHTML("silk/world.png") + " ShipTypes";
