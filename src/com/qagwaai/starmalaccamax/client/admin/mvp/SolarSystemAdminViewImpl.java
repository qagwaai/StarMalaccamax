 ...
 * 
 */
public class SolarSystemAdminViewImpl extends AbstractView<SolarSystemAdminPresenter> implements AdminFileUpload,
    SolarSystemAdminView {
    ...
    private IButton visualizeButton = new IButton("Visualize");
    private IButton clearFiltersButton = new IButton("Clear All Filters");
    private Menu contextMenu = new Menu();
    private MenuItem planetsMenu = new MenuItem("Show Planets for this System");
    private MenuItem visualizePlanetsMenu = new MenuItem("Visualize Planets for this System");
	 ...
	 * 
	 */
    public SolarSystemAdminViewImpl() {
        super();
    }
     ...
     */
    public SolarSystemAdminViewImpl(final String location) {
        this();
    ...
    /**
     * @return the planetsMenu
     */
    public final MenuItem getPlanetsMenu() {
        return planetsMenu;
    }
    ...
    /**
     * @return the visualizeButton
     */
    public IButton getVisualizeButton() {
        return visualizeButton;
    }

    /**
     * @return the visualizePlanetsMenu
     */
    public final MenuItem getVisualizePlanetsMenu() {
        return visualizePlanetsMenu;
    }
    ...
    public final void layout() {
        ...
        String title = Canvas.imgHTML("silk/world.png") + " Solar Systems";
        ...
        gridButtonBar.addMember(visualizeButton);
        ...
        contextMenu.setItems(planetsMenu, visualizePlanetsMenu);
    }

    /*
     * (non-Javadoc)
     * 
     * @see com.qagwaai.starmalaccamax.client.admin.mvp.SolarSystemAdminView#
     * showContextMenu
