 ...
 * 
 */
public class PlanetAdminViewImpl extends AbstractView<PlanetAdminPresenter> implements AdminFileUpload, PlanetAdminView {
    /**
     * 
     * @author pgirard
     * 
     */
    private final class AssignLocationToShipClickHandlerImplementation implements
         ...
         *            the ship to update
         */
        public AssignLocationToShipClickHandlerImplementation(final ShipDTO ship) {
            this.ship = ship;
        }

        @Override
        public void onClick(final MenuItemClickEvent event) {
            PlanetRecord selected = (PlanetRecord) listGrid.getSelectedRecord();
            getPresenter().assignLocationToShip(ship, selected.toPlanet());
        }
    }
    ...
    private MenuItem marketsForPlanet = new MenuItem("Show Market for this Planet");
     ...
     */
    public PlanetAdminViewImpl(final String location) {
        this();
     ...
     * 
     * @param ship
     *            the ship associated with this menu item
     */
    public final void addContextMenuItem(final ShipDTO ship) {
        MenuItem assignLocationToShip = new MenuItem("Assign location to " + ship.getName());
        assignLocationToShip.addClickHandler(new AssignLocationToShipClickHandlerImplementation(ship));
        contextMenu.addItem(assignLocationToShip);
     ...
     */
    public final MenuItem getMarketsForPlanetMenuItem() {
        return marketsForPlanet;
    }
    ...
    public final void layout() {
        ...
        String title = Canvas.imgHTML("silk/world.png") + " Planets";
        ...
        contextMenu.setItems(marketsForPlanet);
    }
