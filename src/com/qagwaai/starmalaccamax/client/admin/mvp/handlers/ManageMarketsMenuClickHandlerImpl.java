 ...
 * 
 */
public final class ManageMarketsMenuClickHandlerImpl implements com.smartgwt.client.widgets.menu.events.ClickHandler {
    /**
	 * 
	 */
     ...
     */
    public ManageMarketsMenuClickHandlerImpl(final EventBus eventBus) {
    ...
    public void onClick(final MenuItemClickEvent event) {
        HistoryManager.present(Locations.getMarketAdminPage(), eventBus, new MarketDTO(), null);
    }
}
