 ...
 * 
 */
public final class ManagePlanetsMenuClickHandlerImpl implements com.smartgwt.client.widgets.menu.events.ClickHandler {
    /**
	 * 
	 */
     ...
     */
    public ManagePlanetsMenuClickHandlerImpl(final EventBus eventBus) {
    ...
    public void onClick(final MenuItemClickEvent event) {
        HistoryManager.present(Locations.getPlanetAdminPage(), eventBus, new PlanetDTO(), null);
    }
}