 ...
 * 
 */
public class JobAdminViewImpl extends AbstractView<JobAdminPresenter> implements AdminFileUpload, JobAdminView {
     ...
     */
    public JobAdminViewImpl(final String location) {
        this();
    ...
    public final void layout() {
        ...
        String title = Canvas.imgHTML("silk/world.png") + " " + constants.jobAdminView_jobSectionTitle();
