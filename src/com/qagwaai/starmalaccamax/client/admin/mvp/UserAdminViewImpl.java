 ...
 * 
 */
public class UserAdminViewImpl extends AbstractView<UserAdminPresenter> implements AdminFileUpload, UserAdminView {
     ...
     */
    public UserAdminViewImpl(final String location) {
        this();
    ...
    public final void layout() {
        ...
        label.setHeight(10);
        label.setWidth100();
        label.setContents("Users");
        baseLayout.addMember(label);
     ...
     * 
     * @see
     * com.qagwaai.starmalaccamax.client.admin.mvp.UserAdminView#showContextMenu
     * (com.smartgwt.client.widgets.grid.events.RowContextClickEvent)
     */
    @Override
    public void showContextMenu(final RowContextClickEvent event) {
