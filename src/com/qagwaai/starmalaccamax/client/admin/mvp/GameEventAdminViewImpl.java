 ...
 * 
 */
public class GameEventAdminViewImpl extends AbstractView<GameEventAdminPresenterImpl> implements GameEventAdminView {
     ...
     */
    public GameEventAdminViewImpl(final String location) {
        this();
    ...
    public final void layout() {
        ...
        String title = Canvas.imgHTML("silk/world.png") + " " + constants.gameEventAdminView_gameEventSectionTitle();
