 ...
 * 
 */
public class ClosestAdminViewImpl extends AbstractView<ClosestAdminPresenter> implements AdminFileUpload,
    ClosestAdminView {
     ...
     */
    public ClosestAdminViewImpl(final String location) {
        this();
    ...
    public final void layout() {
        ...
        String title = Canvas.imgHTML("silk/world.png") + " " + constants.closestAdminView_closestSectionTitle();
