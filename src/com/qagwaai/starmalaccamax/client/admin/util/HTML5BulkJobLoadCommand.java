 ...
 * 
 */
public final class HTML5BulkJobLoadCommand extends BaseThreadedHTML5LoadCommand implements HTML5BulkLoadCommand {
     ...
     */
    public HTML5BulkJobLoadCommand(final AdminFileUpload view) {
        super(view);
    }

    @Override
    public void add(final ArrayList toAdd, final int fileLine) {
        ServiceFactory.getSolarSystemService().execute(new BulkAddJob(toAdd),
            new BaseAsyncCallback<BulkAddJobResponse>() {
                ...
                @Override
                public void onSuccess(final BulkAddJobResponse result) {
    ...
    public Object parseLine(final String buffer) throws TransformationException {
        return DelimitedToRecord.toJob(buffer);
    }
