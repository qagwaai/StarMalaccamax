 ...
 * 
 */
public final class HTML5BulkMarketLoadCommand extends BaseThreadedHTML5LoadCommand implements HTML5BulkLoadCommand {
     ...
     */
    public HTML5BulkMarketLoadCommand(final AdminFileUpload view) {
        super(view);
    }

    @Override
    public void add(final ArrayList toAdd, final int fileLine) {
        ServiceFactory.getMarketService().execute(new BulkAddMarket(toAdd),
            new BaseAsyncCallback<BulkAddMarketResponse>() {
                ...
                @Override
                public void onSuccess(final BulkAddMarketResponse result) {
    ...
    public Object parseLine(final String buffer) throws TransformationException {
        return DelimitedToRecord.toMarket(buffer);
    }
