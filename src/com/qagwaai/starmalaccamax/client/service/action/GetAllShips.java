 ...
 * 
 */
public final class GetAllShips implements IsSerializable, Action<GetAllShipsResponse> {
     ...
     *            the row to end on
     */
    public GetAllShips(final int startRow, final int endRow) {
        usePaging = true;
     ...
     *            any sorts
     */
    public GetAllShips(final int startRow, final int endRow, final ArrayList<Filter> criteria, final String sortBy) {
