 ...
 * 
 */
public final class GetAllStars implements IsSerializable, Action<GetAllStarsResponse> {
     ...
     *            the row to end on
     */
    public GetAllStars(final int startRow, final int endRow) {
        usePaging = true;
     ...
     *            any sorts
     */
    public GetAllStars(final int startRow, final int endRow, final ArrayList<Filter> criteria, final String sortBy) {
