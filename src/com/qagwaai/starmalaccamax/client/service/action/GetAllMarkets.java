 ...
 * 
 */
public final class GetAllMarkets implements IsSerializable, Action<GetAllMarketsResponse> {
     ...
     *            the row to end on
     */
    public GetAllMarkets(final int startRow, final int endRow) {
        usePaging = true;
     ...
     *            any sorts
     */
    public GetAllMarkets(final int startRow, final int endRow, final ArrayList<Filter> criteria, final String sortBy) {
