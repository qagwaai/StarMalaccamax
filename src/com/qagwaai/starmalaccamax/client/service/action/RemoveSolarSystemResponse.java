 ...
 * 
 */
public final class RemoveSolarSystemResponse extends AbstractResponse implements IsSerializable {
    /**
	 * 
	 */
    ...
    public String toString() {
        return "RemoveSolarSystemResponse [solarSystem=" + solarSystem + "]";
    }
