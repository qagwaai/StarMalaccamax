 ...
 * 
 */
public final class GetAllPlanets implements IsSerializable, Action<GetAllPlanetsResponse> {
     ...
     *            the row to end on
     */
    public GetAllPlanets(final int startRow, final int endRow) {
        usePaging = true;
     ...
     *            any sorts
     */
    public GetAllPlanets(final int startRow, final int endRow, final ArrayList<Filter> criteria, final String sortBy) {
