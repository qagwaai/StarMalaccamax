 ...
 * 
 */
public final class GetAllCountries implements IsSerializable, Action<GetAllCountriesResponse> {
     ...
     *            the row to end on
     */
    public GetAllCountries(final int startRow, final int endRow) {
        usePaging = true;
     ...
     *            any sorts
     */
    public GetAllCountries(final int startRow, final int endRow, final ArrayList<Filter> criteria, final String sortBy) {
    ...
    public String toString() {
        final int maxLen = 10;
        return "GetAllCountries [criteria="
