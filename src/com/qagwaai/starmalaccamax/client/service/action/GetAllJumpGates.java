 ...
 * 
 */
public final class GetAllJumpGates implements IsSerializable, Action<GetAllJumpGatesResponse> {
     ...
     *            the row to end on
     */
    public GetAllJumpGates(final int startRow, final int endRow) {
        usePaging = true;
     ...
     *            any sorts
     */
    public GetAllJumpGates(final int startRow, final int endRow, final ArrayList<Filter> criteria, final String sortBy) {
    ...
    public String toString() {
        final int maxLen = 10;
        return "GetAllJumpGates [criteria="
