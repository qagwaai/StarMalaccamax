 ...
 * 
 */
public final class GetAllGameEvents implements IsSerializable, Action<GetAllGameEventsResponse> {
     ...
     *            the row to end on
     */
    public GetAllGameEvents(final int startRow, final int endRow) {
        usePaging = true;
     ...
     *            any sorts
     */
    public GetAllGameEvents(final int startRow, final int endRow, final ArrayList<Filter> criteria, final String sortBy) {
    ...
    public String toString() {
        final int maxLen = 10;
        return "GetAllGameEvents [criteria="
