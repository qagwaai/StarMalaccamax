 ...
 * 
 */
public final class GetAllJobs implements IsSerializable, Action<GetAllJobsResponse> {
     ...
     *            the row to end on
     */
    public GetAllJobs(final int startRow, final int endRow) {
        usePaging = true;
     ...
     *            any sorts
     */
    public GetAllJobs(final int startRow, final int endRow, final ArrayList<Filter> criteria, final String sortBy) {
