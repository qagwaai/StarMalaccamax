 ...
 * 
 */
public final class GetAllSolarSystems implements IsSerializable, Action<GetAllSolarSystemsResponse> {
     ...
     *            the row to end on
     */
    public GetAllSolarSystems(final int startRow, final int endRow) {
        usePaging = true;
     ...
     *            any sorts
     */
    public GetAllSolarSystems(final int startRow, final int endRow, final ArrayList<Filter> criteria,
        final String sortBy) {
    ...
    public String toString() {
        final int maxLen = 10;
        return "GetAllSolarSystems [criteria="
