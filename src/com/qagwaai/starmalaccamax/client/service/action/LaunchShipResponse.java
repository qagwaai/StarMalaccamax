 ...
 * 
 */
public final class LaunchShipResponse extends AbstractResponse implements IsSerializable {
    /**
	 * 
	 */
    ...
    public String toString() {
        return "LaunchShipResponse [gameEvent=" + gameEvent + "]";
    }
     ...
     *            the event
     */
    public LaunchShipResponse(final GameEventDTO gameEvent) {
        super();
        this.gameEvent = gameEvent;
    }
