 ...
 * 
 */
public final class GetAllClosests implements IsSerializable, Action<GetAllClosestsResponse> {
     ...
     *            the row to end on
     */
    public GetAllClosests(final int startRow, final int endRow) {
        usePaging = true;
     ...
     *            any sorts
     */
    public GetAllClosests(final int startRow, final int endRow, final ArrayList<Filter> criteria, final String sortBy) {
    ...
    public String toString() {
        final int maxLen = 10;
        return "GetAllClosests [criteria="
