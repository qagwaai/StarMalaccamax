 ...
 * 
 */
public final class GetAllCaptains implements IsSerializable, Action<GetAllCaptainsResponse> {
     ...
     *            the row to end on
     */
    public GetAllCaptains(final int startRow, final int endRow) {
        usePaging = true;
     ...
     *            any sorts
     */
    public GetAllCaptains(final int startRow, final int endRow, final ArrayList<Filter> criteria, final String sortBy) {
    ...
    public String toString() {
        final int maxLen = 10;
        return "GetAllCaptains [criteria="
