 ...
 * 
 */
public final class GetAllTimezones implements IsSerializable, Action<GetAllTimezonesResponse> {
     ...
     *            the row to end on
     */
    public GetAllTimezones(final int startRow, final int endRow) {
        usePaging = true;
     ...
     *            any sorts
     */
    public GetAllTimezones(final int startRow, final int endRow, final ArrayList<Filter> criteria, final String sortBy) {
    ...
    public String toString() {
        final int maxLen = 10;
        return "GetAllTimezones [criteria="
