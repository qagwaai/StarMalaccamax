 ...
 * 
 */
public final class UpdateSolarSystemResponse extends AbstractResponse implements IsSerializable {
    /**
	 * 
	 */
    ...
    public String toString() {
        return "UpdateSolarSystemResponse [solarSystem=" + solarSystem + "]";
    }
