 ...
 * 
 */
public abstract class GotAllCaptains extends BaseAsyncCallback<GetAllCaptainsResponse> {
    /**
     * notify that we got a new user
     * 
     * @param captains
     *            the captains found by the command or null
     */
    public abstract void got(final ArrayList<CaptainDTO> captains);
