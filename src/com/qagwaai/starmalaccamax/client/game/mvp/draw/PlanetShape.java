 ...
 * 
 */
public final class PlanetShape extends AbstractShape {
    /**
	 * 
	 */
    private int orbit;
     ...
     *            the fill color
     */
    public PlanetShape(final int orbit, final float cx, final float cy, final int radius, final String color) {
        this.orbit = orbit;
        this.cx = cx;
        this.cy = cy;
        this.radius = radius;
