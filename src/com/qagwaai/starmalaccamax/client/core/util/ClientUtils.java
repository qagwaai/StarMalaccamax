...
import com.qagwaai.starmalaccamax.client.OAuth.OurCallbackUrl;
import com.qagwaai.starmalaccamax.client.OAuth.OurProtectedUrls;
import com.qagwaai.starmalaccamax.shared.model.CredentialDTO;

public class ClientUtils
{
    private final static String SESSION_ID_COOKIE         = "starmalaccamax_session_id";
    private final static String AUTH_PROVIDER_COOKIE      = "starmalaccamax_provider";
    private final static String AUTH_PROVIDER_NAME_COOKIE = "starmalaccamax_provider_name";
    private final static String USERNAME_COOKIE           = "starmalaccamax_user";
    private final static String REDIRECT_URL_COOKIE       = "starmalaccamax_redirect_url";
